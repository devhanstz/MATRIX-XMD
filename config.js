...
BOT_NAME: process.env.BOT_NAME || "『 𝐌𝐀𝐓𝐑𝐈𝐗 𝐗𝐌𝐃 』",
// Enter Your Bot Name
...
DESCRIPTION: process.env.DESCRIPTION || "*© Gᴇɴᴇʀᴀᴛᴇᴅ ʙʏ MᴀᴛʀɪxXᴍᴅ*",
// add bot owner name   
 
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/c29j5P5/OIG2-4.jpg",
// add img for alive msg

LIVE_MSG: process.env.LIVE_MSG || "> [🤠] MᴀᴛʀɪxXᴍᴅ ɪs ᴏɴʟɪɴᴇ*⚡",
// add alive msg here 
