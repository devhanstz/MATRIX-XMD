...
cmd({
  ...
  try {
    ...
    if (currentVersion === latestVersion) {
      message = `Your 𝐌𝐀𝐓𝐑𝐈𝐗-𝐗𝐌𝐃 bot is up-to-date! 😊\n Current version is: ${currentVersion}`;
    } else {
      message = `Your 𝐌𝐀𝐓𝐑𝐈𝐗-𝐗𝐌𝐃 bot is outdated 😵!\n\n  Current version: ${currentVersion} \n Latest version: ${latestVersion}`;
    }
...
//});
       // Send the status message with an image
        await conn.sendMessage(from, { 
            image: { url: `https://i.ibb.co/CBnbVQ9/mrgmax.jpg` },  // Image URL
            caption: message,
            contextInfo: {
        ...
        console.error("Error in 𝐌𝐀𝐓𝐑𝐈𝐗-𝐗𝐌𝐃 checking Version:", e);
